...
class VoiceSwitcherRepositoryImpl(private val context: Context) : VoiceSwitcherRepository {
    ...
    override suspend fun getVoiceAudio(voiceId: Int, sampleId: Int): File? = withContext(Dispatchers.IO) {
        ...
        val response: HttpResponse =
            createKtorClient().use {
                it.get("https://static.dailyfriend.ai/conversations/samples/$voiceId/$sampleId/audio.mp3")
            }
