...
class VoiceSwitcherViewModel(private val voiceRepository: VoiceSwitcherRepository) : ViewModel() {
  var voiceSwitcherProps by mutableStateOf(VoiceSwitcherProps())
    private set

  init {
    voiceSwitcherProps = voiceSwitcherProps.copy(items = voiceRepository.getVoiceItems())
  }
